            ...
            self.findByUsername(username, function (err, user) {
                ...
                if (user) {
                    ...
                    if (user.verified == false){
                        return cb(null, false, {message: "Email verification needed"})
                    } else {
                ...
                user.setActivationKey(function (err, user) {
                    ...
                    .then(function() {
                        ...
                        text: "Wlcome.\n\n" +
                            ...
                            "http://127.0.0.1:3000/" +user.username+ "/activate/" + user.activationKey + "\n\n" +
    ...
    UserSchema.setResetPasswordKey = function (username, cb) {
        ...
        self.findByUsername(username, function (err, user) {
            ...
            crypto.randomBytes(options.resetPasswordkeylen, function (err, buf) {
                ...
                user.save()
                .then(function() {
                    console.log("after save " +randomHex+", "+ user.username);
                    var smtpTransport = nodemailer.createTransport({
                        service: "Gmail", 
                        auth: {
                            user: "user",
                    ...
                    text: "You are receiving this because you (or someone else) have requested the reset of the password for your account.\n\n" +
                        "Please click on the following link, or paste this into your browser to complete the process:\n\n" +
                        "http://127.0.0.1:3000/" +user.username+ "/reset/" + randomHex + "\n\n" +
